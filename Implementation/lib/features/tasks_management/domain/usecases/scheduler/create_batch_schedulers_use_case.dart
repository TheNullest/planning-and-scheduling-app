...
//TODO: Implement chunking for large batches to process them in smaller chunks.
  ...
  EResultFutureVoid call(SchedulersAggregateEntity params) async {
    try {
      final timeRanges = params.scheduleConstraintAggregate.timeExceptions
      ...
      await _dateRangeRepository.createBatch(params.scheduleConstraintAggregate.dateExceptions);
