  ...
  EResultFuture<List<SchedulersAggregateEntity>> call() async {
    ...
    for (final constraint in constraints) {
      final scheduleConstraint = ScheduleConstraintAggregate(
        ...
        timeExceptions:
            constraint.timeRangeExceptionIds.map((id) => allTimeExceptions[id]!).toList(),
        dateExceptions:
            constraint.dateRangeExceptionIds.map((id) => allDateExceptions[id]!).toList(),
      );
