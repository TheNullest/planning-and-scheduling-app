...
class GetSubTasksByStatusUsecase
    extends UsecaseWithDynamicParams<SubTaskRepository, List<SubTaskEntity>, TaskStatus> {
  GetSubTasksByStatusUsecase(super.repository);

  @override
  EResultFuture<List<SubTaskEntity>> call(UsecaseParams<TaskStatus> params) async =>
