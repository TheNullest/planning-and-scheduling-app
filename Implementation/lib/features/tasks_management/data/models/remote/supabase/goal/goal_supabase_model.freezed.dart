...
class _$GoalSupabaseModelImpl implements _GoalSupabaseModel {
  ...
  @override
  String toString() {
    return 'GoalSupabaseModel(mainTaskId: $mainTaskId, measurementUnitId: $measurementUnitId, measurementValue: $measurementValue, id: $id, subTaskId: $subTaskId, userId: $userId, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, perActiveHour: $perActiveHour, perActiveDay: $perActiveDay, perActiveWeek: $perActiveWeek, perActiveMonth: $perActiveMonth, perActiveYear: $perActiveYear)';
  }
...
abstract class _GoalSupabaseModel implements GoalSupabaseModel {
  const factory _GoalSupabaseModel(
          {required final String mainTaskId,
