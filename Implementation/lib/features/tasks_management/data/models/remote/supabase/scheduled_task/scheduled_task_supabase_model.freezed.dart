...
ScheduledTaskSupabaseModel _$ScheduledTaskSupabaseModelFromJson(
    Map<String, dynamic> json) {
  return _ScheduledTaskSupabaseModel.fromJson(json);
}

/// @nodoc
mixin _$ScheduledTaskSupabaseModel {
  ...
  @JsonKey(
      name: 'scheduled_task_specific_times',
      includeToJson: false,
  ...
  /// Serializes this ScheduledTaskSupabaseModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ScheduledTaskSupabaseModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ScheduledTaskSupabaseModelCopyWith<ScheduledTaskSupabaseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ScheduledTaskSupabaseModelCopyWith<$Res> {
  factory $ScheduledTaskSupabaseModelCopyWith(ScheduledTaskSupabaseModel value,
          $Res Function(ScheduledTaskSupabaseModel) then) =
      _$ScheduledTaskSupabaseModelCopyWithImpl<$Res,
...
/// @nodoc
class _$ScheduledTaskSupabaseModelCopyWithImpl<$Res,
        $Val extends ScheduledTaskSupabaseModel>
    implements $ScheduledTaskSupabaseModelCopyWith<$Res> {
  _$ScheduledTaskSupabaseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ScheduledTaskSupabaseModelImplCopyWith<$Res>
    implements $ScheduledTaskSupabaseModelCopyWith<$Res> {
  factory _$$ScheduledTaskSupabaseModelImplCopyWith(
          _$ScheduledTaskSupabaseModelImpl value,
          $Res Function(_$ScheduledTaskSupabaseModelImpl) then) =
      __$$ScheduledTaskSupabaseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? id,
...
/// @nodoc
class __$$ScheduledTaskSupabaseModelImplCopyWithImpl<$Res>
    extends _$ScheduledTaskSupabaseModelCopyWithImpl<$Res,
        _$ScheduledTaskSupabaseModelImpl>
    implements _$$ScheduledTaskSupabaseModelImplCopyWith<$Res> {
  __$$ScheduledTaskSupabaseModelImplCopyWithImpl(
      _$ScheduledTaskSupabaseModelImpl _value,
      $Res Function(_$ScheduledTaskSupabaseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ScheduledTaskSupabaseModelImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$ScheduledTaskSupabaseModelImpl implements _ScheduledTaskSupabaseModel {
  const _$ScheduledTaskSupabaseModelImpl(
      {required this.id,
  ...
  factory _$ScheduledTaskSupabaseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ScheduledTaskSupabaseModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ScheduledTaskSupabaseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ScheduledTaskSupabaseModelImplCopyWith<_$ScheduledTaskSupabaseModelImpl>
      get copyWith => __$$ScheduledTaskSupabaseModelImplCopyWithImpl<
          _$ScheduledTaskSupabaseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ScheduledTaskSupabaseModelImplToJson(
      this,
    );
  }
}

abstract class _ScheduledTaskSupabaseModel
    implements ScheduledTaskSupabaseModel {
  const factory _ScheduledTaskSupabaseModel(
  ...
  factory _ScheduledTaskSupabaseModel.fromJson(Map<String, dynamic> json) =
      _$ScheduledTaskSupabaseModelImpl.fromJson;
