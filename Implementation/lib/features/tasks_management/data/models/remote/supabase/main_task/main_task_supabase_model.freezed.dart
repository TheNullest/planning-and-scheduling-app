...
class _$TaskSupabaseModelImpl implements _TaskSupabaseModel {
  ...
  @override
  String toString() {
    return 'TaskSupabaseModel(id: $id, title: $title, colorCode: $colorCode, iconCode: $iconCode, userId: $userId, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, priority: $priority, status: $status, dueDate: $dueDate, totalSpentTime: $totalSpentTime, taskSchedulerId: $taskSchedulerId)';
  }
