...
class _$TaskActivitySupabaseModelImpl implements _TaskActivitySupabaseModel {
  ...
  @override
  String toString() {
    return 'TaskActivitySupabaseModel(taskId: $taskId, subTaskId: $subTaskId, startAt: $startAt, id: $id, isPaused: $isPaused, updatedAt: $updatedAt, description: $description, createdAt: $createdAt, userId: $userId, dueDate: $dueDate, spentTime: $spentTime)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, taskId, subTaskId, startAt, id,
      isPaused, updatedAt, description, createdAt, userId, dueDate, spentTime);
