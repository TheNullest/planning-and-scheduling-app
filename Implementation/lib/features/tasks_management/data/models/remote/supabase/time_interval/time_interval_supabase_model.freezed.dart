...
class _$TaskActivitySupabaseModelImpl implements _TaskActivitySupabaseModel {
  ...
  @override
  String toString() {
    return 'TaskActivitySupabaseModel(taskId: $taskId, subTaskId: $subTaskId, startAt: $startAt, id: $id, updatedAt: $updatedAt, description: $description, createdAt: $createdAt, userId: $userId, endAt: $endAt, spentTime: $spentTime)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, taskId, subTaskId, startAt, id,
      updatedAt, description, createdAt, userId, endAt, spentTime);
