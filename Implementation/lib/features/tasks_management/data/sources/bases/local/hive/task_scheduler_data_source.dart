...
abstract class TaskSchedulerDataSource<
  ...
  /// Returns a [EResultFuture] containing a list of [TaskSchedulerModel]
  /// objects.
  EResultFuture<List<TaskSchedulerModel>> getTaskSchedulersByEndTime(
    DateTime endAt,
  );
  ...
  /// Returns a [EResultFuture] containing a list of [TaskSchedulerModel]
  /// objects.
  EResultFuture<List<TaskSchedulerModel>> getTaskSchedulersByRepetitionType(
  ...
  /// Returns a [EResultFuture] containing a list of [TaskSchedulerModel]
  /// objects.
  EResultFuture<List<TaskSchedulerModel>> getTaskSchedulersBySpecificTimes(
  ...
  /// Returns a [EResultFuture] containing a list of [TaskSchedulerModel]
  /// objects.
  EResultFuture<List<TaskSchedulerModel>> getTaskSchedulersByStartTime(
    DateTime startAt,
  );
  ...
  /// Returns a [EResultFuture] containing a list of [TaskSchedulerModel]
  /// objects.
  EResultFuture<List<TaskSchedulerModel>> getTaskSchedulersByTimeUnit(
    TimeUnit timeUnit,
  );
  ...
  /// Returns a [EResultFuture] containing a list of [TaskSchedulerModel]
  /// objects.
  EResultFuture<List<TaskSchedulerModel>> getTaskSchedulersWithinDateRange({
