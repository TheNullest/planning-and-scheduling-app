...
abstract class TimeIntervalDataSource<
  ...
  ///
  /// Returns a [EResultFuture] containing a list of [TimeIntervalModel] objects.
  EResultFuture<List<TimeIntervalModel>> getScheduledTimesByMainTaskId(
    String mainTaskId,
  );
  ...
  /// Returns a [EResultFuture] containing a list of [TimeIntervalModel].
  EResultFuture<List<TimeIntervalModel>>
  ...
  /// Returns a [EResultFuture] containing a list of [TimeIntervalModel].
  EResultFuture<List<TimeIntervalModel>> getTimeIntervalBySubTaskId(
    String subTaskId,
  );
}
