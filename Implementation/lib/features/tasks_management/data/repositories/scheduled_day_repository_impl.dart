...
class ScheduledDayRepositoryImpl extends BaseRepositoryImpl<
    ...
    SupabaseDataSource<ScheduledDaySupabaseModel, ScheduledDayDataMapper>,
    ScheduledDayDataMapper> implements ScheduledDayRepository {
  ...
  final SupabaseDataSource<ScheduledDaySupabaseModel, DataMapper> _remoteDataSource;
