...
class TagFormController extends BaseFormController<TagEntity> {
  TagFormController({required super.userId});

  TagFormController.fromEntity({required TagEntity entity}) : super(userId: entity.userId) {
    initialize(entity);
  }
  @override
