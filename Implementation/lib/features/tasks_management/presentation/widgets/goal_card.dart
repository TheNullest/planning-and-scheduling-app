...
import 'package:zamaan/features/tasks_management/presentation/dialogs/goal_upsert_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<GoalsManagerBloc, GoalsManagerState>(
        ...
        listener: (context, state) => state.maybeWhen(
              ...
              updated: (_) => goalVm.handleEntityUpdated(),
              orElse: () => {},
            ),
              ...
              builder: (_, states, __) {
                return Card(
                  ...
                  child: InkWell(
                    ...
                    onTap: () => showGoalUpsertDialog(context, goalVm),
                    child: Padding(
