...
class _TaskFormWidgetState extends State<TaskFormWidget> {
  ...
  late final TextEditingController _desciptionController;
  ...
  void initState() {
    super.initState();
    taskFormController = context.read<TaskFormController>();
    _titleController = TextEditingController(
      text: taskFormController.title,
    );
    _desciptionController = TextEditingController(
      text: taskFormController.description,
    );
  }
        ...
        child: Column(
          children: [
                ...
                builder: (context, reset, _) {
                  if (reset) {
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      _titleController.text = taskFormController.title;
                      // Optionally, you might want to reset the flag here.
                      taskFormController.resetTextController = false;
                    });
                  }
              ...
              child: Selector<TaskFormController, bool>(
                ...
                builder: (_, reset, __) {
                  if (reset) {
                    // Schedule the update after the current frame.
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      _desciptionController.text = taskFormController.description ?? '';
                      // Optionally, you might want to reset the flag here.
                      // taskFormController.resetTextController = false;
                    });
                  }
                        ...
                        onTap: () async {
                          final pickedColor = await showDialog<Color>(
                            ...
                            builder: (_) => AlertDialog(
                              ...
                              content: BlockPicker(
                                pickerColor: taskFormController.color,
                                onColorChanged: (c) => Navigator.of(context).pop(c),
                              ),
                            ),
                          );
                          if (mounted && pickedColor != null) {
                            taskFormController.color = pickedColor;
                          }
                        },
            ...
            CustomDropdownButtonWidget<TaskUpsertVM, IconData>(
              ...
              onChanged: (iconData) => taskFormController.icon = iconData!,
            ),
