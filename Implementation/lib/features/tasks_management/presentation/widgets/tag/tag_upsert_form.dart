...
class TagUpsertFormWidget extends StatefulWidget {
  const TagUpsertFormWidget(this.taskId, {super.key});
  final String? taskId;

  @override
  State<TagUpsertFormWidget> createState() => _TagUpsertFormWidgetState();
}

class _TagUpsertFormWidgetState extends State<TagUpsertFormWidget> {
  TagsManagerBloc get tagsManagerBloc => context.read<TagsManagerBloc>();
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ActionButtonsWidget(
            onSubmit: () {
              tagsManagerBloc.add(TagsManagerEvent.create(tagVM.toEntity));
            },
            onUpdate: () => tagsManagerBloc.add(TagsManagerEvent.update(tagVM.toEntity)),
