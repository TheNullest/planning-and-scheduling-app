...
class HiveTimeIntervalDataSourceImpl
  ...
  ///
  /// Returns a [ResultFuture] containing a list of [TimeIntervalHiveModel] objects.
  @override
  ResultFuture<List<TimeIntervalHiveModel>> getScheduledTimesByMainTaskId(
    String mainTaskId,
  ) async {
  ...
  /// Returns a [ResultFuture] containing a list of [TimeIntervalHiveModel].
  @override
  ResultFuture<List<TimeIntervalHiveModel>>
  ...
  /// Returns a [ResultFuture] containing a list of [TimeIntervalHiveModel].
  @override
  ResultFuture<List<TimeIntervalHiveModel>> getTimeIntervalBySubTaskId(
    String subTaskId,
  ) async {
    return _hiveBox.operator<List<TimeIntervalHiveModel>>(
      job: (box) async {
